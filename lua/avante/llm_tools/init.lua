...
You can delete the first file by providing a path of "directory1/a/something.txt"
  ...
  require("avante.llm_tools.edit_file"),
  {
    ...
    param = {
      ...
      usage = {
        explanation = "One sentence explanation as to why this tool is being used, and how it contributes to the goal.",
        query = "The search term to look up on the web. Be specific and include relevant keywords for better results. For technical queries, include version numbers or dates if relevant.",
      },
    },
    returns = {
      {
